...
void set_reboot_from_ota_flag(bool _onoff)
{
	struct sys_monitor_t *sys_monitor = sys_monitor_get_instance();
    sys_monitor->reboot_from_ota_flag = _onoff;
}

bool get_reboot_from_ota_flag(void)
{
	struct sys_monitor_t *sys_monitor = sys_monitor_get_instance();
	return sys_monitor->reboot_from_ota_flag;
}
