...
typedef enum {
	...
	/** audio effect operation enable drc functions */
	MEDIA_EFFECT_EXT_SET_DRC_ENABLE,
	/** audio effect operation Set the front soft volume */
	MEDIA_EFFECT_EXT_SET_PRECUT,
	/** audio effect operation Set peq param */
	MEDIA_EFFECT_EXT_SET_PEQ_PARAM,
	...
	/** audio effect get pitch level*/
	MEDIA_EFFECT_EXT_GET_OKMIC_PITCH_LEVEL,
	/** audio effect set pitch level*/
	MEDIA_EFFECT_EXT_SET_OKMIC_PITCH_LEVEL,
	/** audio effect get okmic music solf volume*/
	MEDIA_EFFECT_EXT_GET_OKMIC_MUSIC_SOLF_VOL,
	/** audio effect set okmic solf volume*/
	MEDIA_EFFECT_EXT_SET_OKMIC_MUSIC_SOLF_VOL,
	/** audio effect get okmic mic solf volume*/
	MEDIA_EFFECT_EXT_GET_OKMIC_MIC_SOLF_VOL,
	/** audio effect set okmic mic solf volume*/
	MEDIA_EFFECT_EXT_SET_OKMIC_MIC_SOLF_VOL,
	/** audio effect set okmic mix mode*/
	MEDIA_EFFECT_EXT_SET_OKMIC_MIX_MODE,
	/**audio effect set voice removal enable/disable*/
	MEDIA_EFFECT_EXT_SET_OKMIC_VOICE_REMOVAL,
	/**audio effect get mic first enable or disable*/
	MEDIA_EFFECT_EXT_GET_DUCKING_STATUS,
	/**audio effect set mic first enable or disable*/
	MEDIA_EFFECT_EXT_SET_DUCKING,
	/**audio effect get echo ratio*/
	MEDIA_EFFECT_EXT_GET_ECHO_DELAY,
	/**audio effect get echo ratio*/
	MEDIA_EFFECT_EXT_SET_ECHO_DELAY,
	/**audio effect update mic bypass param*/
	MEDIA_EFFECT_EXT_UPDATE_MIC_BYPASS,
	/**audio effect update echo param*/
	MEDIA_EFFECT_EXT_UPDATE_ECHO_PARAM,
	/**audio effect update reverb param*/
	MEDIA_EFFECT_EXT_UPDATE_REVERB_PARAM,
	/**audio effect get voice removal enable or disable*/
	MEDIA_EFFECT_EXT_GET_VOICE_REMOVAL_STATUS,
	/**audio effect set voice removal enable or disable*/
	MEDIA_EFFECT_EXT_SET_VOICE_REMOVAL,

} media_param_e;

/*okmic effect output mode*/
typedef enum {
	MEDIA_OKMIC_OUTPUT_DEFAULT = 0,
	MEDIA_OKMIC_OUTPUT_L_ONLY,
	MEDIA_OKMIC_OUTPUT_R_ONLY,
	MEDIA_OKMIC_OUTPUT_L_R_MIX,
	MEDIA_OKMIC_OUTPUT_MIC_MUTE,
	MEDIA_OKMIC_OUTPUT_MIC_ONLY,

	MEDIA_OKMIC_OUTPUT_MODE,
} media_okmic_output_mode_e;
...
typedef struct {
	...
	u8_t capture_attach_channels;
	io_stream_t capture_input_stream;
	io_stream_t capture_output_stream;
	io_stream_t capture_attach_stream;
	io_stream_t capture_output_pcm_stream;
...
void *resample_service_init(u8_t in_channels, u8_t out_channels,
		u8_t samplerate_in, u8_t samplerate_out, u8_t stream_type,
		struct acts_ringbuf *res_in, io_stream_t out_stream);

void resample_service_stream_notify(void *handle);

int resample_service_exit(void *handle);
