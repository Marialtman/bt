...
/**
 * @brief Read active connect devcie RSSI
 *
...
struct btsrv_a2dp_start_param {
	...
	u8_t a2dp_cp_scms_t:1;		/* Support content protection SCMS-T */
	u8_t a2dp_delay_report:1;	/* Support delay report */
};
...
typedef void (*btsrv_avrcp_pass_ctrl_callback)(void *param, u8_t cmd, u8_t state);
