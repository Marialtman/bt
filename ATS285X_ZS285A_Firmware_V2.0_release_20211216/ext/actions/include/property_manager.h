...
#define CFG_OKMIC_GLOBAL_PARA       "OKMIC_GLOBAL_PARA"
#define CFG_OKMIC_MIC_VOLUME		"OKMIC_MIC_VOLUME"
#define CFG_OKMIC_ECHO_DELAY		"OKMIC_ECHO_DELAY"
#define CFG_OKMIC_ECHO_DECAY		"OKMIC_ECHO_DECAY"
#define CFG_OKMIC_ECHO_LOWPASS_FC1	"OKMIC_ECHO_LOWPASS_FC1"
#define CFG_OKMIC_ECHO_LOWPASS_FC2	"OKMIC_ECHO_LOWPASS_FC2"
#define CFG_OKMIC_ECHO_DECAY_TIMES	"OKMIC_ECHO_DECAY_TIMES"
#define CFG_OKMIC_BYPASS			"OKMIC_BYPASS"
...
/**
 * @brief clear user property region
 *
 * @details This routine clear user property region
 *
 * @return != 0  init failed
 * @return == 0  init success
 */
