 ...
 */
int hostif_bt_conn_read_rssi(struct bt_conn *conn, s8_t *rssi);
...
int hostif_bt_avrcp_ct_set_absolute_volume(struct bt_conn *conn, u32_t param);
...
/** @brief Init stack storage.
 *
 *  @param cb Call back for flush property.
 *
 *  @return 0 in case of success and error code in case of error.
 */
int hostif_stack_storage_init(stack_storage_cb cb);

/** @brief Deinit stack storage.
 *
 *  @return 0 in case of success and error code in case of error.
 */
int hostif_stack_storage_deinit(void);

/** @brief Get storage linkkey.
 *
 *  @param info Memory for return linkkey.
 *  @param cnt Max number linkkey get.
 *
 *  @return 0 in case of success and error code in case of error.
 */
int hostif_stack_storage_get_linkkey(struct br_linkkey_info *info, u8_t cnt);

/** @brief Update storage linkkey.
 *
 *  @param info update linkkeys.
 *  @param cnt Max number linkkey update.
 *
 *  @return 0 in case of success and error code in case of error.
 */
int hostif_stack_storage_update_linkkey(struct br_linkkey_info *info, u8_t cnt);

/** @brief Write original linkkey.
 *
 ...
 *  @return 0 in case of success and error code in case of error.
 */
int hostif_stack_storage_write_ori_linkkey(bt_addr_t *addr, u8_t *link_key);

/** @brief Clear linkkey.
 *
 *  @return NONE.
 */
void hostif_stack_storage_clean_linkkey(void);
...
void hostif_bt_l2cap_reg_br_conn_rsp_cb(bt_br_conn_rsp_result_cb cb);
